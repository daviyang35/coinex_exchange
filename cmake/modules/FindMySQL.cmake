...
if (MYSQL_FOUND)
    if (NOT MYSQL_FIND_QUIETLY)
        ...
        message(STATUS "MYSQL_INCLUDE_DIR includes: ${MYSQL_INCLUDE_DIR}")
        message(STATUS "MYSQL_LIBRARIES libraries: ${MYSQL_LIBRARIES}")
    endif ()
else ()
    if (MYSQL_FIND_REQUIRED)
        message(STATUS "Looked for MySQL libraries named ${MYSQL_NAMES}.")
        message(FATAL_ERROR "Cannot found MySQL, please install manually.")
    endif ()
endif ()
